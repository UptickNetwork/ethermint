...
var (
	...
	fd_ChainConfig_prague_block         protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ChainConfig_prague_block = md_ChainConfig.Fields().ByName("prague_block")
}
...
func (x *fastReflection_ChainConfig) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.PragueBlock != "" {
		value := protoreflect.ValueOfString(x.PragueBlock)
		if !f(fd_ChainConfig_prague_block, value) {
			return
		}
	}
}
...
func (x *fastReflection_ChainConfig) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "ethermint.evm.v1.ChainConfig.prague_block":
		return x.PragueBlock != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_ChainConfig) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "ethermint.evm.v1.ChainConfig.prague_block":
		x.PragueBlock = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ethermint.evm.v1.ChainConfig"))
		}
...
func (x *fastReflection_ChainConfig) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "ethermint.evm.v1.ChainConfig.prague_block":
		panic(fmt.Errorf("field prague_block of message ethermint.evm.v1.ChainConfig is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ethermint.evm.v1.ChainConfig"))
		}
...
func (x *fastReflection_ChainConfig) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.PragueBlock) > 0 {
			i -= len(x.PragueBlock)
			copy(dAtA[i:], x.PragueBlock)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.PragueBlock)))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xc2
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 24:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field PragueBlock", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.PragueBlock = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
type ChainConfig struct {
	...
	PragueBlock string `protobuf:"bytes,24,opt,name=prague_block,json=pragueBlock,proto3" json:"prague_block,omitempty"`
}
...
func (x *ChainConfig) GetPragueBlock() string {
	if x != nil {
		return x.PragueBlock
	}
	return ""
...
var file_ethermint_evm_v1_evm_proto_rawDesc = []byte{
	...
	0x22, 0xd2, 0x0f, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x61, 0x6e, 0x63, 0x75, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x53, 0x0a, 0x0c, 0x70, 0x72,
	0x61, 0x67, 0x75, 0x65, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x18, 0x20, 0x01, 0x28, 0x09,
	0x42, 0x30, 0xda, 0xde, 0x1f, 0x15, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x73, 0x64, 0x6b, 0x2e,
	0x69, 0x6f, 0x2f, 0x6d, 0x61, 0x74, 0x68, 0x2e, 0x49, 0x6e, 0x74, 0xf2, 0xde, 0x1f, 0x13, 0x79,
	0x61, 0x6d, 0x6c, 0x3a, 0x22, 0x70, 0x72, 0x61, 0x67, 0x75, 0x65, 0x5f, 0x62, 0x6c, 0x6f, 0x63,
	0x6b, 0x22, 0x52, 0x0b, 0x70, 0x72, 0x61, 0x67, 0x75, 0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4a,
	...
	0x6d, 0x6f, 0x76, 0x65, 0x64, 0x22, 0x8b, 0x02, 0x0a, 0x08, 0x54, 0x78, 0x52, 0x65, 0x73, 0x75,
	...
	0x12, 0x52, 0x0a, 0x07, 0x74, 0x78, 0x5f, 0x6c, 0x6f, 0x67, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x4c, 0x6f, 0x67, 0x73, 0x42, 0x16, 0xc8, 0xde, 0x1f, 0x00, 0xf2, 0xde, 0x1f, 0x0e, 0x79, 0x61,
	0x6d, 0x6c, 0x3a, 0x22, 0x74, 0x78, 0x5f, 0x6c, 0x6f, 0x67, 0x73, 0x22, 0x52, 0x06, 0x74, 0x78,
	...
	0x74, 0x75, 0x72, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x42, 0xb9, 0x01, 0x0a, 0x14, 0x63, 0x6f,
	0x6d, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x65, 0x76, 0x6d, 0x2e,
	0x76, 0x31, 0x42, 0x08, 0x45, 0x76, 0x6d, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x35,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x65, 0x76, 0x6d, 0x6f, 0x73,
	0x2f, 0x65, 0x74, 0x68, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x65,
